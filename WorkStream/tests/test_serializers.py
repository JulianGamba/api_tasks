...
from WorkStream.models import Task, Priority, State, CustomUser, Comment
from WorkStream.serializers import TaskReadSerializer, TaskWriteSerializer, StateSerializer, PrioritySerializer, LoginSerializer, CustomUserSerializer, CommentSerializer
...
class TaskSerializerTest(APITestCase):
    ...
    def test_task_read_serialization(self):
        ...
        self.assertEqual(data['comment']['id'], self.task.comment.id)
